...
class Emp_SignIn extends StatefulWidget {
  const Emp_SignIn({Key? key}) : super(key: key);

  @override
  State<Emp_SignIn> createState() => _Emp_SignInState();
}

class _Emp_SignInState extends State<Emp_SignIn> {
    ...
    return Row(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => Emp_SignUp()));
          },
          child: const Text(
            " Sign Up",
